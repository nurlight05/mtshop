				...
				<div class="category__cards" id="main">
					<aside class="breadcrumbs">
                        ...
                        @if($category)
                            ...
                            <a href="{{ route('mtshop.catalogue.index') }}">
                                Каталог
                            </a>
                            <i class="fa fa-angle-right" aria-hidden="true">
                            </i>
                            @if ($category->parent)
                                ...
                                @if ($item->parent)
                                    @php
                                        $item2 = $item->parent;
                                    @endphp
                                    <a href="{{ route('mtshop.catalogue.index', ['category' => $item2->slug]) }}">
                                        {{ $item2->name }}
                                    </a>
                                    <i class="fa fa-angle-right" aria-hidden="true">
                                    </i>
                                @endif
                                <a href="{{ route('mtshop.catalogue.index', ['category' => $item->slug]) }}">
                                    {{ $item->name }}
                                </a>
                                <i class="fa fa-angle-right" aria-hidden="true">
                                </i>
					...
					<div class="category__card__sort">
						<label>
                            @if ($category)
                                Показано все товары из каталога: <span>{{ $category->name }}</span>
                            @else
                                Показано все товары
                            @endif
                        </label>
