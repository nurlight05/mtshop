							...
							<div class="filter level-filter level-req">
					            <div id="rangeSlider" class="range-slider">
									...
									<div class="range-group">
										<input class="range-input" value="30" min="30" max="432000" step="10" type="range" style="" />
										<input class="range-input" value="432000" min="30" max="432000" step="10" type="range" style="" />
									</div>
			...
			<div class="col-lg-9 col-md-12">
				<div class="category__cards" id="main">
					...
					<div class="category__card__sort">
						<label>Показано все товары из каталога: <span>Инструменты</span></label>
						<div class="">
